...
?>
<div class="container">
    <?= $jumbo->getJumbo("View  patients", "View patients List") ?>
        ...
        <tbody>
            <?php while ($row = $patientsList->fetch(PDO::FETCH_ASSOC)) {
                ...
                <tr>
                    ...
                    <td><?= $row['dor'] ?></td>
                    <td><?= $row['contact'] ?></td>
                    <td><a title="Edit Patient" href="editPatient.php?id=<?= $row['user_id'] ?>" class="btn btn-sm btn-warning fa fa-pencil"></a> </td>
                    <td><a title="Add Diagnosis" href="addDiagnosis.php?id=<?= $row['user_id'] ?>" class="btn btn-sm btn-default fas fa-hospital-o"></a> </td>
                    <td><a title="Refer patient" onclick="modal(<?= $row['user_id'] ?>)" class="btn btn-sm btn-default fa fa-ambulance"></a> </td>
                    <td><a title="Delete Patient" class="delete btn btn-danger btn-sm fa fa-trash-o" onclick="Delete(<?= $row['user_id'] ?>)"></a></td>
                </tr>
            <?php } ?>
        </tbody>
